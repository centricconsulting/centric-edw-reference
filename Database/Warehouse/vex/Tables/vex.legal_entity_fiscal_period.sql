CREATE TABLE [vex].[legal_entity_fiscal_period] (
    ...
    CONSTRAINT [vex_legal_entity_fiscal_period_pk] PRIMARY KEY CLUSTERED ([legal_entity_fiscal_period_version_key] ASC)
);


GO

CREATE UNIQUE NONCLUSTERED INDEX [vex_legal_entity_fiscal_period_u1]
    ON [vex].[legal_entity_fiscal_period]([legal_entity_fiscal_period_key] ASC) WHERE ([version_latest_ind]=(1));
