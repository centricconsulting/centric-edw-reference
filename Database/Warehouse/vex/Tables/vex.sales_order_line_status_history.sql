CREATE TABLE [vex].[sales_order_line_status_history] (
    ...
    CONSTRAINT [vex_sales_order_line_status_history_pk] PRIMARY KEY CLUSTERED ([sales_order_line_status_history_version_key] ASC)
);


GO

CREATE UNIQUE NONCLUSTERED INDEX [vex_sales_order_line_status_history_u1]
    ON [vex].[sales_order_line_status_history]([sales_order_line_status_history_key] ASC) WHERE ([version_latest_ind]=(1));
