CREATE TABLE [vex].[customer] (
    ...
    CONSTRAINT [vex_customer_pk] PRIMARY KEY CLUSTERED ([customer_version_key] ASC)
);


GO

CREATE UNIQUE NONCLUSTERED INDEX [vex_customer_u1]
    ON [vex].[customer]([customer_key] ASC) WHERE ([version_latest_ind]=(1));
