CREATE TABLE [vex].[customer_xref] (
    ...
    CONSTRAINT [vex_customer_xref_pk] PRIMARY KEY CLUSTERED ([customer_xref_version_key] ASC)
);


GO
CREATE UNIQUE NONCLUSTERED INDEX [vex_customer_xref_u1]
    ON [vex].[customer_xref]([customer_xref_key] ASC) WHERE ([version_latest_ind]=(1));
