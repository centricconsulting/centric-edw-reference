CREATE TABLE [vex].[legal_entity] (
    ...
    CONSTRAINT [vex_legal_entity_pk] PRIMARY KEY CLUSTERED ([legal_entity_version_key] ASC)
);


GO

CREATE UNIQUE NONCLUSTERED INDEX [vex_legal_entity_u1]
    ON [vex].[legal_entity]([legal_entity_key] ASC) WHERE ([version_latest_ind]=(1));
