CREATE TABLE [vex].[sales_order] (
    ...
    CONSTRAINT [vex_sales_order_pk] PRIMARY KEY CLUSTERED ([sales_order_version_key] ASC)
);


GO

CREATE UNIQUE NONCLUSTERED INDEX [vex_sales_order_u1]
    ON [vex].[sales_order]([sales_order_key] ASC) WHERE ([version_latest_ind]=(1));
