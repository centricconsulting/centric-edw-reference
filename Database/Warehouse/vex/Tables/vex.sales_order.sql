...
, CONSTRAINT vex_sales_order_pk PRIMARY KEY (sales_order_version_key)
)
;
GO

CREATE UNIQUE INDEX vex_sales_order_u1 ON vex.sales_order (sales_order_version_key) WHERE version_latest_ind = 1;
GO
