...
, CONSTRAINT vex_country_pk PRIMARY KEY (country_version_key)
)
;
GO

CREATE UNIQUE INDEX vex_country_u1 ON vex.country (country_version_key) WHERE version_latest_ind = 1;
GO
