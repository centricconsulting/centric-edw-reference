CREATE TABLE [vex].[sales_order_line_status] (
    ...
    CONSTRAINT [vex_sales_order_line_status_pk] PRIMARY KEY CLUSTERED ([sales_order_line_status_version_key] ASC)
);


GO

CREATE UNIQUE NONCLUSTERED INDEX [vex_sales_order_line_status_u1]
    ON [vex].[sales_order_line_status]([sales_order_line_status_key] ASC) WHERE ([version_latest_ind]=(1));
